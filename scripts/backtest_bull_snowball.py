...
from trading_config import (
    ...
    BOUNCE_MAX_ENTRIES, BOUNCE_SNOWBALL_LEVELS, BOUNCE_SNOWBALL_SIZES, BOUNCE_TRAIL_ACTIVATION, BOUNCE_MIN_SCORE, BOUNCE_CD,
            ...
            if not did_snowball:
                ...
                if act in ('OPEN_LONG_ENTRY_1','OPEN_SHORT_ENTRY_1'):
                    ...
                    if entry.get('bounce', False):
                        cd_l_until = idx + BOUNCE_CD
                    elif safe_flag and not short_flag and not is_sh:
                        cd_l_until = idx + SAFE_CD
